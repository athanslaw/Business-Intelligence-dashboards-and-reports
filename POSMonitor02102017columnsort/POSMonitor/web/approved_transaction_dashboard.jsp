...
<% HelperClass.activeClass = "approved_transaction_dashboard"; %>
...
<section class="content-header">
    <h1>Successful Transaction by Cards Dashboard</h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Dashboard</a></li>
        <li><a href="#">Successful Transaction Dashboard</a></li>
    </ol>
</section>
                                ...
                                <div class="col-sm-12"><!-- Pagination -->
                                    ...
                                    <div style="text-align:center">
                                        <section class="content-header" style="margin-left: -8px !important; margin-right: -10px !important; border-bottom: none;">
                                            <div class="alert alert-info">Successful Analysis by Cards between <%= datefrom1 + " and " + dateto2%></h2>
                                        </section>	
                                    </div>
                                </div>
                            </div>
...
<div class="row">
            <%
                terminalgrandtotal = helper.view_record_single("SELECT count(*) AS total FROM ATMALERT.CHANNEL_RESPONSE c JOIN ATMALERT.RESPONSE_CODE r ON c.AUTH_RESPONSE_CODE = r.RESP_CODE WHERE c.FEED_TIMESTAMP >= '" + datefrom1 + "' AND c.FEED_TIMESTAMP <= '" + dateto1 + "' AND r.STATUS = 'Approved'");
                ...
                <!-- small box -->
                    <div class="small-box bg-green">
                        <div class="inner">
                            ...
                            <p>Total Successful Tnxs. Count</p>
                        </div>
                    <a href="#" class="small-box-footer"> <i>(<%= datefrom1 + " to " + dateto2%>)</i></a>
                </div>
            </div>
            <!-- ./col -->
                    ...
                    <div class="small-box bg-green-active">
                        <div class="inner">
                            <h4><strong><% number =terminalgrandtotal.getInt("total");
                                ...
                                %><%=moneyString%></strong></h4>
                                <p>Successful Tnxs. Count (Other Banks)<br></p>
                        </div>
                    <a href="#" class="small-box-footer"> <a href="#" class="small-box-footer"> <i>(<%= datefrom1 + " to " + dateto2%>)</i></a></a>
                </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-4 col-xs-4">
                    ...
                    <div class="small-box bg-green">
                        <div class="inner">
                            <h4><strong><% 
                                ...
                                %><%=moneyString%></strong></h4>
                                <p>Total Successful Txns. Count (UBA)<br></p>
                        </div>
                    <a href="#" class="small-box-footer"> <a href="#" class="small-box-footer"> <i>(<%= datefrom1 + " to " + dateto2%>)</i></a></a>
                </div>
            </div>
